...
export default function Post(props){
    ...
    return(
        <div data-test="post" class="post">
                ...
                <div class="conteudo">
                    <img data-test="post-image" onClick={heart2} src={props.imgpost} alt="gato-telefone" />
                </div>

                <div class="fundo">
                    <div class="acoes">
                        <div>
                            <ion-icon data-test="like-post" class={cor} onClick={heart} name={coracao}></ion-icon>
                            <ion-icon name="chatbubble-outline"></ion-icon>
                            <ion-icon name="paper-plane-outline"></ion-icon>
                        </div>
                        <div>
                            <ion-icon data-test="save-post" onClick={bookmark} name={nome}></ion-icon>
                        </div>
                    </div>
